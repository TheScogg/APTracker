...
export function serializeIssue(row) {
  ...
  return {
    ...
    workflowStateByEntryHistory: parseJson(row.workflow_state_by_entry_history_json, null),
    workflowStateByStatus: parseJson(row.workflow_state_by_status_json, null),
...
export function serializeIssueAttachment(row) {
  ...
  return {
    ...
    plantId: row.plant_id,
    type: row.type,
    solutionRevisionId: row.solution_revision_id || null,
